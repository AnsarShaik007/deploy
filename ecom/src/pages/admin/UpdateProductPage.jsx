        ...
        <div className="login_Form  px-8 py-6 border border-black rounded-xl shadow-md">
          ...
          <div className="mb-3">
            <select
              ...
              className="w-full px-1 py-2 text-black  border border-black rounded-md outline-none  "
            >
          ...
          <div className="mb-3">
            <textarea
              ...
              rows="5"
              className=" w-full px-2 py-1 text-black  border border-black rounded-md outline-none placeholder-black "
            ></textarea>
          </div>
