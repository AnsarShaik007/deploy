  ...
  return (
    <Layoout>
      <div className=" container mx-auto px-4 py-5 lg:py-8">
        ...
        <div className="top ">
          {/* main  */}
          <div className="  py-5 rounded-xl border border-black ">
            {/* image  */}
            <div className="flex justify-center">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSAL1JT6g2AXAX4hPYHVOanA4HLwnOIwyplIg&s"
                alt=""
              />
            </div>
            {/* text  */}
                  ...
                  <div key={index}>
                    {order.cartItems.map((item, index) => {
                      ...
                      return (
                        ...
                        >
                          {/* main 3  */}
                          <div className="w-full border-r border-black   md:max-w-xs">
                            {/* left  */}
                            <div className="p-8">
